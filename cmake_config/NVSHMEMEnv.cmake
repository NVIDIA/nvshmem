...
nvshmem_add_default_off_option(NVSHMEM_CFT_HANDLES_SUPPORT "Enable NVSHMEM Logical Endpoint support")
...
nvshmem_add_default_environment_path(DOCA_HOME "" "path to GPUNetIO Open source tree (defaults to vendored copy)")
...
if (DEFINED ENV{NVSHMEM_DEVICELIB_CUDA_ARCHITECTURES})
  set(NVSHMEM_DEVICELIB_CUDA_ARCHITECTURES_DEFAULT
      "$ENV{NVSHMEM_DEVICELIB_CUDA_ARCHITECTURES}")
else()
  set(NVSHMEM_DEVICELIB_CUDA_ARCHITECTURES_DEFAULT "AUTO")
endif()
set(NVSHMEM_DEVICELIB_CUDA_ARCHITECTURES
    "${NVSHMEM_DEVICELIB_CUDA_ARCHITECTURES_DEFAULT}" CACHE STRING
    "Device-library CUDA architectures: AUTO, INHERIT, or a CMake architecture list")
set_property(CACHE NVSHMEM_DEVICELIB_CUDA_ARCHITECTURES PROPERTY STRINGS AUTO INHERIT)
...
NVSHMEM_CFT_HANDLES_SUPPORT=${NVSHMEM_CFT_HANDLES_SUPPORT} \
