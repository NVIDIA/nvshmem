...
#define TEST_NVSHMEM_ALL_CUBIN()                                                       \
    ...
    CU_CHECK(cuLaunchKernel(test_all_cubin, 1, 1, 1, 1, 1, 1, _dynamic_smem_size, cstrm, args_all, NULL));
...
#define TEST_NVSHMEM_RING_CUBIN()                                                       \
    ...
    CU_CHECK(cuFuncSetAttribute(test_ring_cubin,                                        \
                                CU_FUNC_ATTRIBUTE_MAX_DYNAMIC_SHARED_SIZE_BYTES,         \
                                (int)_dynamic_smem_size));                               \
    CU_CHECK(cuLaunchKernel(test_ring_cubin, 1, 1, 1, 1, 1, 1, _dynamic_smem_size, cstrm, args_ring, NULL));
