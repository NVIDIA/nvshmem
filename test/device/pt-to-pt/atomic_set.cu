...
#define TEST_NVSHMEM_ATOMIC_SET_CUBIN(TYPENAME, TYPE, OP)                                    \
    void *args_##TYPENAME##_set_##OP[] = {(void *)&remote, (void *)&_dynamic_smem_size};     \
    ...
    CU_CHECK(cuLaunchKernel(test_##TYPENAME##_set_##OP##_cubin, 1, 1, 1, 1, 1, 1,            \
                            _dynamic_smem_size, 0, args_##TYPENAME##_set_##OP, NULL));
