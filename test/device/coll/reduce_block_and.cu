...
NVSHMEMTEST_REPT_FOR_BITWISE_REDUCE_TYPES_WITH_SCOPE2(DECL_TYPENAME_OP_REDUCE, block, _block,
                                                      x, and)
...
NVSHMEMTEST_REPT_FOR_BITWISE_REDUCE_TYPES_WITH_SCOPE2(DEFN_TYPENAME_OP_REDUCE, block, _block,
                                                      x, and)
#if defined __cplusplus || defined NVSHMEM_HOSTLIB_ONLY
}
#endif
