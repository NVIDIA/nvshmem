## Description: <br>
Route NVSHMEM tuning to data collection, remote transport, NIC-to-PE mapping, or TMA. <br>
...
Apache-2.0 <br>
## Use Case: <br>
Developers and engineers tuning NVSHMEM performance across GPU clusters, routing requests to specialist workflows for baseline data collection, remote transport selection, NIC-to-PE mapping, or TMA enablement. <br>
...
## Evaluation Tasks: <br>
8 evaluation tasks (7 positive, 1 negative) across isolated k8s-sandbox pods, 3 attempts per task. <br>
