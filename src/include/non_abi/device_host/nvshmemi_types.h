...
/* Keep counted-operation state separate from the generic TMA and handle
 * barrier pools so independently in-flight operations cannot alias it. */
#define NVSHMEMI_COUNTED_STATE_SLOT_BYTES 16
#define NVSHMEMI_COUNTED_STATUS_SLOT 0
#define NVSHMEMI_COUNTED_HANDLE_BARRIER_SLOT 1
#define NVSHMEMI_COUNTED_TMA_BARRIER_SLOT 2
#define NVSHMEMI_COUNTED_READY_BARRIER_SLOT 3
#define NVSHMEMI_COUNTED_REUSABLE_BARRIER_SLOT 5
#define NVSHMEMI_COUNTED_NUM_STATE_SLOTS 7
#define NVSHMEMI_COUNTED_STATE_BYTES \
    (NVSHMEMI_COUNTED_NUM_STATE_SLOTS * NVSHMEMI_COUNTED_STATE_SLOT_BYTES)

#define NVSHMEMI_SMEM_DATA_REGION_OFFSET                                 \
    (NVSHMEMI_TMA_BARRIER_REGION_BYTES + NVSHMEMI_HANDLE_BARRIER_BYTES + \
     NVSHMEMI_COUNTED_STATE_BYTES)
...
enum { NVSHMEMI_TEAM_DUP_COUNT = 128, NVSHMEMI_NVLS_MAX_CTA_COUNT = NVSHMEMI_TEAM_DUP_COUNT };
...
typedef nvshmemi_team_v4 nvshmemi_team_t;
