...
def generate_cooperative_launch_functions():
    ...
    # Barrier functions
    functions.extend([
        "nvshmem_barrier", "nvshmem_barrier_all", "nvshmemx_barrier_block", "nvshmemx_barrier_warp",
        "nvshmemx_barrier_all_block", "nvshmemx_barrier_all_warp"
    ])

    # Sync functions
    functions.extend([
        "nvshmem_sync", "nvshmem_sync_all", "nvshmem_team_sync", "nvshmemx_sync_block", "nvshmemx_sync_warp",
        "nvshmemx_sync_all_block", "nvshmemx_sync_all_warp", "nvshmemx_team_sync_block", "nvshmemx_team_sync_warp"
    ])
    ...
    for data_type in types:
        ...
        functions.extend([
            ...
            f"nvshmem_{data_type}_wait_until_any", f"nvshmem_{data_type}_wait_until_some",
            f"nvshmem_{data_type}_wait_until_all_vector", f"nvshmem_{data_type}_wait_until_any_vector",
            f"nvshmem_{data_type}_wait_until_some_vector"
        ])

        # Test operations
        functions.extend([
            f"nvshmem_{data_type}_test", f"nvshmem_{data_type}_test_all", f"nvshmem_{data_type}_test_any",
            f"nvshmem_{data_type}_test_some", f"nvshmem_{data_type}_test_all_vector",
            f"nvshmem_{data_type}_test_any_vector", f"nvshmem_{data_type}_test_some_vector"
        ])

    # Memory-based collective operations
    functions.extend([
        "nvshmem_alltoallmem", "nvshmemx_alltoallmem_block", "nvshmemx_alltoallmem_warp", "nvshmem_broadcastmem",
        "nvshmemx_broadcastmem_block", "nvshmemx_broadcastmem_warp", "nvshmem_fcollectmem",
        "nvshmemx_fcollectmem_block", "nvshmemx_fcollectmem_warp"
    ])
