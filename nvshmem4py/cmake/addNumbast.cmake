...
function(AddNumbast VERSION)
    ...
    set(NUMBAST_COMMAND "env" "${NUMBAST_LD_LIBRARY_PATH}" "${NUMBAST_PATH}" "${VENV_PYTHON_EXECUTABLE}" "${ASSET_DIR}/numbast/run_numbast.py" "--cfg-path" "${ASSET_DIR}/numbast/config_nvshmem.yml" "--output-dir" "${NUMBAST_OUTPUT_DIR}" "--bypass-parse-error" "true")
