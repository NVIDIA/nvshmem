...
# so that addCybind and addNumbast will run again.
...
set(NUMBAST_MLIR_OUTPUT "${BINDINGS_BASE}/device/numba_cuda_mlir/_numbast.py")
...
if(EXISTS "${NUMBAST_MLIR_OUTPUT}")
    file(REMOVE "${NUMBAST_MLIR_OUTPUT}")
    message(STATUS "Force rebuild: removed ${NUMBAST_MLIR_OUTPUT}")
endif()
